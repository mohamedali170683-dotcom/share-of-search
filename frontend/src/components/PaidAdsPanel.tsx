...
export function PaidAdsPanel({ domain, brandName, competitors, locationCode = 2840, languageCode = 'en' }: PaidAdsPanelProps) {
  ...
  // AI Insights
  const [insights, setInsights] = useState<PaidAdsInsights | null>(null);
  ...
  const fetchAIInsights = async (paidData: PaidAdsResponse) => {
    ...
    try {
      const response = await fetch('/api/generate-channel-insights', {
        ...
        body: JSON.stringify({
          ...
          brandName,
          paidAdsData: {
            yourDomain: paidData.yourDomain,
            competitors: paidData.competitors,
            sov: paidData.sov,
            totalMarket: paidData.totalMarket,
          },
          competitors,
        }),
      });
        ...
        {insights && (
          <div className="space-y-4">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
              ...
              <p className="text-purple-700 dark:text-purple-300 text-sm">{insights.budgetRecommendation}</p>
            </div>
