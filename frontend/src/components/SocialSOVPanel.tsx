          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6 max-w-md mx-auto">
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                <p className="text-sm text-amber-800 dark:text-amber-200 font-medium">Requires Apify Setup</p>
                <p className="text-xs text-amber-700 dark:text-amber-300 mt-1">
                  Add your APIFY_API_TOKEN to environment variables and subscribe to the required actors.
                </p>
              </div>
            </div>
          </div>
