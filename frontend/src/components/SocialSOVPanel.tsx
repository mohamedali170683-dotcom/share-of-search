          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6 max-w-md mx-auto">
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                <p className="text-sm text-blue-800 dark:text-blue-200 font-medium">Powered by Apify</p>
                <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                  Scrapes real mentions from social platforms. Analysis may take 1-2 minutes.
                </p>
              </div>
            </div>
          </div>
