      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-2">
          <div className="flex items-center gap-2 p-2 bg-emerald-50 dark:bg-emerald-900/30 rounded">
            <span className="font-bold text-emerald-600 dark:text-emerald-400">SOV &gt; SOS (Positive):</span>
            <span className="text-sm">Growth potential! Your visibility exceeds brand awareness.</span>
          </div>
          <div className="flex items-center gap-2 p-2 bg-red-50 dark:bg-red-900/30 rounded">
            <span className="font-bold text-red-600 dark:text-red-400">SOV &lt; SOS (Negative):</span>
          ...
          <div className="flex items-center gap-2 p-2 bg-blue-50 dark:bg-blue-900/30 rounded">
            <span className="font-bold text-blue-600 dark:text-blue-400">SOV ≈ SOS (Balanced):</span>
        ...
        <table className="w-full text-sm">
          <tbody>
            <tr className="border-b dark:border-gray-600">
              <td className="py-2 font-bold text-emerald-600 dark:text-emerald-400">40%+</td>
              <td className="py-2">Category Leader - You own the category in consumers' minds</td>
            </tr>
            <tr className="border-b dark:border-gray-600">
              <td className="py-2 font-bold text-emerald-600 dark:text-emerald-400">25-40%</td>
              <td className="py-2">Major Player - Strong brand, top 2-3 in category</td>
            </tr>
            <tr className="border-b dark:border-gray-600">
              <td className="py-2 font-bold text-yellow-600 dark:text-yellow-400">15-25%</td>
              <td className="py-2">Established - Recognized brand with solid demand</td>
            </tr>
            <tr className="border-b dark:border-gray-600">
              <td className="py-2 font-bold text-orange-600 dark:text-orange-400">8-15%</td>
              <td className="py-2">Challenger - Growing brand, building awareness</td>
            </tr>
            <tr>
              <td className="py-2 font-bold text-red-600 dark:text-red-400">&lt;8%</td>
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-2">
          <div className="p-3 border dark:border-gray-600 rounded">
            <span className="font-bold text-orange-600 dark:text-orange-400">1. Improve Rankings</span>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Moving from #5 to #1 increases visibility by 7x for that keyword.</p>
          </div>
          <div className="p-3 border dark:border-gray-600 rounded">
            <span className="font-bold text-orange-600 dark:text-orange-400">2. Target High-Volume Keywords</span>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Ranking #1 for a 10,000-volume keyword = 2,800 clicks vs 28 clicks for a 100-volume keyword.</p>
          </div>
          <div className="p-3 border dark:border-gray-600 rounded">
            <span className="font-bold text-orange-600 dark:text-orange-400">3. Expand Coverage</span>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">More keywords ranked = more total visible volume. Identify gaps where competitors rank but you don't.</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Learn about Share of Search and Share of Voice metrics</p>
      </div>
        ...
        {faqItems.map((item, index) => (
          <div key={index} className="px-6">
            <button
              ...
              className="w-full py-4 flex items-center justify-between text-left hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
            >
              <span className="font-medium text-gray-900 dark:text-white">{item.question}</span>
              <svg
                className={`w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform ${openItems.has(index) ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
